...
public class ProxyHandler {
  ...
  private void enableProxyUrlInMapping(final StubMapping mapping) {
    ...
    final ResponseDefinition copy =
        this.copyResponseDefinition(response, this.proxyUrl.get(mapping.getUuid()));
  ...
  private ResponseDefinition copyResponseDefinition(
      final ResponseDefinition response, final String proxyUrl) {
    final ResponseDefinition copy;
